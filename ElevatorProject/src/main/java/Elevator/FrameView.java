...
public class FrameView implements Runnable
{
	...
	private List<ElevatorStart> elevators; 				// List of the elevators
...
//			        - Math.abs((floors[i] + adjustment) * (levelHeight));
	...
	private Color getStateColor(int i)
	{
		...
		{
		case 0:
			color = Color.YELLOW;										// idle
			break;
		case 1:
			color = Color.RED;											// stopping
			break;
		case 2:
			color = Color.GREEN;										// moving
			break;
		default:
